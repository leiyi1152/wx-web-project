...
r=80):""==e.cgi?(i=S.IDS.APPMSG,r=62):"cgi-bin/frame"==e.cgi&&/t=ad_system/.test(e.href)||/merchant\/ad_/.test(e.cgi)?(i=S.IDS.AD,
...
r=84):"cgi-bin/safecenterstatus"==e.cgi||""==e.cgi||""==e.cgi?(i=S.IDS.SAFE,r=85):"cgi-bin/illegalrecord"==e.cgi?(i=S.IDS.ILLEGAL,
...
r&&r.length>0&&0==/^https\:\/\/(mp\.weixin\.qq\.com|res\.wx\.qq\.com)/.test(r),0!=i(s,window.navigator.userAgent)&&(S.push({
msg:s+"|onerror",
target:r,
rowNum:t,
colNum:o
...
if(t.report){
for(;r.length;){
var n=!1,i=r.shift(),o=d(i,p.length);
...
if(m){
var u=function(){
clearTimeout(h),console.log("comboReport"+p.join("&")),f(t.report+p.join("&")+"&count="+m+"&_t="+ +new Date),
h=0,p=[];
};
