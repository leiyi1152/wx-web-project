...
public class DateTools {
	   ...
	   * @return 返回格式化的日期
	   */
	  public static Date strToFormateDateTime(String date) throws ParseException {
	        String str = date.substring(0,4)+"-"+date.substring(4,6)+"-"+date.substring(6,8)
	   ...
	   */
	    ...
	    /**
		   ...
		   */
		    ...
		    public static String dateTimeToSimpleStr(Date date) {
		        String str = "";
		        String simpleStr = "";
	            if (date == null) return null;
...
//    	  SimpleDateFormat formatter = new SimpleDateFormat("yyMMddHHmmss");
//    	  String dates = "20091225091010";
//    	  Date date;
//		try {
//			
//			  System.out.println(convertDateToString(strToFormateDateTime(dates),DEFAULT_FORMAT));
//		} catch (ParseException e) {
